 ...
 * 
 * Note that for TCP, the source and sink need to be configured to use the same priority to have the same expected quality of service
 *     Else, a jammer may prevent acknowledgements from reaching the sender, thus jamming an ostensibly high priority source.
 * 
