...
echo "Start ptp..."
sudo ptp4l -f gPTP_master.cfg -i enp87s0 -m &> ptp.log &
echo "ptp4l is running in bg as pid $!"

sleep 2

echo "Start phc2sys..."
sudo phc2sys -c enp87s0 -s CLOCK_REALTIME -w -m -O 37 &> phc2sys.log &  # assume as client configuration... but what if this device is grand-master?
